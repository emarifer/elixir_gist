...
<img style="margin: 2rem 0;" src="docs/app-logo.png" width="27%">
...
###### Gist page with syntax highlighting and Markdown-style comments section:

<img style="margin-bottom: 1.5rem;" src="docs/screenshot-01.png" width="50%" align="top">
